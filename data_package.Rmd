...
`*` Due to the size of the raw data, the package can only contain a subset of the data in thess categories. If you wish to use the full extent of the raw data, please contact the package developer for further data request.
